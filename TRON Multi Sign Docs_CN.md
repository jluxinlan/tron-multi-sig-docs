...
多签服务是支持对Tron链多重签名功能支持的服务。多签服务缓存用户提交的交易，其他用户更新交易补充签名。等签名足够，多签自动广播交易。
...
签名完成后，将交易对象再次通过 /openapi/multi/transaction提交至多签服务。多签服务会自动验证签名有效性及权重，满足阈值后自动广播。开发者可以通过返回的交易 Hash 跟踪交易进度。
